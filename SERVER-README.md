...
> ⚠️ Эта инструкция — для старой схемы (mobile API + веб на конкретном
> сервере). Актуальное развёртывание Telegram-бота на чистом VPS —
> в [DEPLOY.md](DEPLOY.md) (`bash deploy/deploy.sh`).
