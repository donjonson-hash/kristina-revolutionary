...
const labels = {changed: 'Текст изменился', only_left: 'Только в A', only_right: 'Только в B', moved: 'Перемещено без изменения текста', reflow: 'Изменены переносы строк', matched: 'Текст совпал'};
